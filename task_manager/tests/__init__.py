...
2. Constructing the path to a directory named "task_manager\\src"
within the current working directory.
3. Modifying the Python module search path to include the
"task_manager\\src" directory.
...
SOURCE_PATH = os.path.join(PROJECT_PATH, "task_manager\\src")
