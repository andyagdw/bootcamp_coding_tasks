...
class Email:
    ...
    location = "United Kingdom"  # Class variable

    def __init__(self,  # Create instance variables
                email_address,
                subject_line,
                email_content,
                ):
    ...
    def mark_as_read(self, value):  # Instance methods
        '''Takes in bool value and assigns instance variable to value'''
        self.has_been_read = value  # Takes in a boolean value
...
############################
# To greet the user when they run the program
print(f"\nHello {my_name}👋\n")
